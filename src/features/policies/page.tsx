      ...
      <div className="container px-4 mx-auto">
        <header className="text-center mb-10 md:mb-14">
          ...
          <p className="mt-3 text-gray-600">
            Entenda como lidamos com informações e privacidade.
          </p>
        </header>
            ...
            <div className="prose prose-gray max-w-none prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-bold prose-h3:text-xl prose-h3:md:text-2xl prose-h3:font-semibold prose-a:text-purple-700 hover:prose-a:text-purple-900 prose-a:no-underline hover:prose-a:underline prose-ol:pl-6 prose-li:my-2 prose-p:leading-relaxed">
              ...
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}>
                  A sua privacidade é importante para nós. É política do Mottivve
                  respeitar a sua privacidade em relação a qualquer informação
                  sua que possamos coletar no site{" "}
                  <Link href="https://www.mottivve.com.br/">Mottivve</Link>, e
              ...
              <ul>
                ...
                <li>
                  <span style={{ color: "rgb(68, 68, 68)" }}>
                    ...
                    usados ​​por este site foram projetados para garantir que
                    você forneça os anúncios mais relevantes sempre que possível,
              ...
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}>
                  ...
                  informação que o Mottivve oferece no site e com caráter
              ...
              <ul>
                <li className="text-gray-900">
                    A) <span style={{ color: "rgb(68, 68, 68)" }}> Não se envolver em atividades que sejam ilegais ou
                    contrárias à boa fé a à ordem pública;
                  </span>
                </li>
                <li className="text-gray-900">
                    B) <span style={{ color: "rgb(68, 68, 68)" }}> Não difundir propaganda ou conteúdo de natureza racista,
                ...
                <li className="text-gray-900">
                    C) <span style={{ color: "rgb(68, 68, 68)" }}> Não causar danos aos sistemas físicos (hardwares) e lógicos
                    (softwares) do Mottivve, de seus fornecedores ou terceiros,
              ...
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}>
                  Esta política é efetiva a partir de&nbsp;7 January 2026 18:10
                </span>
              </p>
            </div>
          </article>
