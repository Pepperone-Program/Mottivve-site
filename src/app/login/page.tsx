...
import LoginFormSection from '@/features/auth/components/login-form-section';
            ...
            <div>
              ...
              <div className="text-center">
                <p className="text-sm">
                  ...
                  <Link className="inline-block text-teal-500 hover:text-yellowGreen-600 font-semibold" href="/register">Sign Up</Link>
                </p>
              </div>
            </div>
          </div>
