          ...
          <div className="container px-4 mx-auto">
            <div className="max-w-5xl mx-auto">
              <div className="flex flex-wrap -mx-4 -mb-8">
                ...
                <div className="w-full xs:w-1/2 md:w-1/4 px-4 mb-8">
                  ...
                  <ul>
                    <li className="mb-6"><Link className="inline-block text-lg text-gray-500 hover:text-gray-900" href={getRouteByName('about')}>Sobre</Link></li>
                    <li className="mb-6"><a className="inline-block text-lg text-gray-500 hover:text-gray-900" href="#">Loja</a></li>
                ...
                <div className="w-full xs:w-1/2 md:w-1/4 px-4 mb-8">
                  ...
                  <ul>
                    <li className="mb-6"><a className="inline-block text-lg text-gray-500 hover:text-gray-900" href="#">Suporte</a></li>
            ...
            <div className="mt-32 pt-12 border-t border-gray-200">
              <div className="flex flex-wrap items-center -mx-4">
                ...
                <div className="w-full lg:w-1/3 px-4">
                  <p className="text-gray-500">Mottivve - &copy; 2026 Todos os direitos reservados.</p>
                </div>
                <div className="w-full lg:w-1/3 px-4">
